...
const run = async () => {
  try {
    ...
    const { jsonString: comprehensiveJsonData, jsonObject: comprehensiveJsonObject } = generateComprehensiveJSON(fileImpacts, columnImpacts, changedFiles, sqlAdded, sqlRemoved, ymlAdded, ymlRemoved);
